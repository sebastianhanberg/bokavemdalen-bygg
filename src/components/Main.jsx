    ...
    <div className="container mx-auto">
      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col mb-6 lg:justify-between lg:flex-row md:mb-8">
          <h2 className="max-w-lg mb-5 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none md:mb-6 group">
            <span className="inline-block mb-1 sm:mb-4">
              Vi har en bred kompetens
              <br className="hidden md:block" />
              över alla områden.
            </span>
            <div className="h-1 ml-auto duration-300 origin-left transform bg-deep-purple-accent-400 scale-x-30 group-hover:scale-x-100" />
          </h2>
          <p className="text-gray-700 lg:text-base text-sm lg:max-w-md">
        ...
        <div className="grid gap-6 row-gap-5 mb-8 lg:grid-cols-4 sm:row-gap-6 sm:grid-cols-2">
          <a href="/" aria-label="View Item">
            <div className="relative overflow-hidden transition duration-200 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl">
              <img
                ...
                alt=""
              />
              <div class="absolute w-full top-0 h-56 md:h-64 xl:h-80 left-0 px-6 py-4 mb-4 bg-gray-dark bg-opacity-50">
                <h4 class="mb-4 text-lg font-bold tracking-tight text-white"><Link to="/tjanster">Projektledning</Link></h4>

              </div>
              <div className="absolute inset-0 px-6 py-4 transition-opacity duration-200 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                <p className="mb-4 text-lg font-bold text-gray-100"><Link to="/tjanster">Projektledning</Link></p>
                <p className="text-sm tracking-wide text-gray-300">
                  <Link to="/tjanster">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</Link>
                </p>
              </div>
            </div>
          </a>
          ...
          <a href="/" aria-label="View Item">
            <div className="relative overflow-hidden transition duration-200 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl">
              <img
                ...
                alt=""
              />
              <div class="absolute top-0 h-56 md:h-64 xl:h-80 left-0 px-6 py-4 mb-4  w-full bg-gray-dark bg-opacity-50">
                <h4 class="mb-4 text-lg font-bold tracking-tight text-white"><Link to="/tjanster">Renovering & nybyggnation</Link></h4>

              </div>

              <div className="absolute inset-0 px-6 py-4 transition-opacity duration-200 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                <p className="mb-4 text-lg font-bold text-gray-100"><Link to="/tjanster">Renovering & nybyggnation</Link></p>
                <p className="text-sm tracking-wide text-gray-300">
                  <Link to="/tjanster">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</Link>
                </p>
          ...
          <a href="/" aria-label="View Item">
            <div className="relative overflow-hidden transition duration-200 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl">
              ...
              />
              <div class="absolute top-0 h-56 md:h-64 xl:h-80 left-0 px-6 py-4 mb-4  w-full bg-gray-dark bg-opacity-50">
                <h4 class="mb-4 text-lg font-bold tracking-tight text-white"><Link to="/tjanster">El- & styrsystem</Link></h4>

              </div>

              <div className="absolute inset-0 px-6 py-4 transition-opacity duration-200 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                <p className="mb-4 text-lg font-bold text-gray-100"><Link to="/tjanster">El- & styrsystem</Link></p>
                <p className="text-sm tracking-wide text-gray-300">
                  <Link to="/tjanster">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</Link>
                </p>
          ...
          <a href="/" aria-label="View Item">
            <div className="relative overflow-hidden transition duration-200 transform rounded shadow-lg hover:-translate-y-2 hover:shadow-2xl">
              ...
              />
              <div class="absolute top-0 h-56 md:h-64 xl:h-80 left-0 px-6 py-4 mb-4  w-full bg-gray-dark bg-opacity-50">
                <h4 class="mb-4 text-lg font-bold tracking-tight text-white"><Link to="/tjanster">Service & installation</Link></h4>

              </div>
              <div className="absolute inset-0 px-6 py-4 transition-opacity duration-200 bg-black bg-opacity-75 opacity-0 hover:opacity-100">
                <p className="mb-4 text-lg font-bold text-gray-100"><Link to="/tjanster">Service & installation</Link></p>
                <p className="text-sm tracking-wide text-gray-300">
                  <Link to="/tjanster">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</Link>
                </p>
        ...
        <div className="text-center">
          <Link to="/tjanster"
            className="inline-flex items-center font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-gray-dark"
          >
            Läs mer
            <svg
