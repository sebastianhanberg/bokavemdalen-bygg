...
function Nav() {
    return (
        <nav className="nav-container z-50 bg-dark-blue bg-opacity-100 shadow-lg py-6 md:px-10 px-7">
            ...
            dark:focus:text-white dark:border-gray-700 dark:hover:bg-gray-700 md:dark:hover:bg-transparent">
                            ...
                            <div id="dropdownNavbar" class="hidden z-10 w-44 bg-dark-blue bg-opacity-75 rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
