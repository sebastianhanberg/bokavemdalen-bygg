    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} >
            <div id="offert" class="container mx-auto mb-10 w-full max-w-xl xl:px-8 xl:w-2/3">
                ...
                <Link to="main" smooth={true} duration={1500} aria-label="" class="container mx-auto flex justify-center mt-10 cursor-pointer items-center font-medium tracking-wider transition-colors duration-200 text-black hover:text-boka-orange">
